    ...
    var batcher_for = _.bind(function (attrs) {
      return new RequestBatcher(attrs.queue_key, {
        ...
        sendRequestFunc: _.bind(function (data, options, cb) {
          // Get the API host for this endpoint type, or fall back to the default api_host
          var api_host =
            this.get_config("api_hosts")[attrs.type] ||
            this.get_config("api_host");
          this._send_request(
            api_host + attrs.endpoint,
  ...
  var ret = this._track_or_batch(
    {
      type: "events",
      data: data,
      endpoint: api_host + "/" + this.get_config("api_routes")["track"],
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */
MixpanelLib.prototype.remove_group = addOptOutCheckMixpanelLib(function (
  group_key,
  group_id,
  callback
) {
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */
MixpanelLib.prototype.track_with_groups = addOptOutCheckMixpanelLib(function (
  event_name,
  properties,
  groups,
  callback
 ...
 * with the tracking payload sent to the API server is returned; otherwise false.
 */
MixpanelLib.prototype.track_pageview = addOptOutCheckMixpanelLib(function (
  properties,
  options
) {
...
MixpanelLib.prototype._run_hook = function (hook_name) {
  var ret = (this["config"]["hooks"][hook_name] || IDENTITY_FUNC).apply(
    this,
